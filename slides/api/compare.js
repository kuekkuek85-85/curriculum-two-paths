...
const CRITERION = `
[판단 기준] 학교자율시간 과목 개발 체크리스트(임휘·백성혜, 2026)의 계획 단계-성격-내용 항목:
"기존 국가 교육과정 및 기승인된 고시 외 과목과의 유사성과 차별점을 명확히 서술하였는가"가 핵심 심의 요소다.
또한 개발 단계-성취기준-내용: "기존 국가 교육과정이나 타 과목 성취기준을 그대로 사용하지 않고 새롭게 개발"
"활용 시 새로운 내용 요소나 맥락을 반영하여 재구조화"를 기준으로 성취기준의 실질적 동일 여부를 본다.
표현만 바꾼 실질적 동일(패러프레이즈)도 '유사'로 강하게 본다.
